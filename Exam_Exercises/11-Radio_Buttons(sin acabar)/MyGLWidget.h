...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  protected:
    ...
    public slots:
        virtual void changeZoom(int newZoom);
        virtual void focoEscena();
        virtual void focoCamara();
  
    signals:
        virtual void updateZoom(int zoomValue);
  ...
  private:
    ...
    // uniform locations
    GLuint transLoc, projLoc, viewLoc, isVacaLoc, isStripedLoc, isFocoEscenaLoc;
    // attribute locations
    ...
    float radiPat, radiVaca;
    float alturaPat, alturaVaca;
