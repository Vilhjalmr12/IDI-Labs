...
void MyGLWidget::carregaShaders()
{
  ...
  isStripedLoc = glGetUniformLocation (program->programId(), "isStriped");
  isFocoEscenaLoc = glGetUniformLocation (program->programId(), "isFocoEscena");
}
...
void MyGLWidget::keyPressEvent(QKeyEvent* event) 
{
  ...
  switch (event->key()) {
    ...
    case Qt::Key_R: { //Rota los modelos
    ...
    case Qt::Key_X: { //Striped/No striped
        isStriped = !isStriped;
        glUniform1i(isStripedLoc, isStriped);
        break;
    }
    case Qt::Key_L: { //Foco de Escena/Foco de camara
        isFocoEscena = !isFocoEscena;
        glUniform1i(isFocoEscenaLoc, isFocoEscena);
        break;
    }
